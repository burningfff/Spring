...
import com.hisense.mysqlfeign.entity.JSONUtils;
import com.hisense.mysqlfeign.entity.JsonResult;
...
@SpringBootTest(classes = MysqlFeignApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
